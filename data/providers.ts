...
export const providers: Provider[] = [
  {
    ...
    contractWorks: false,
    cyber: false,
    description: 'BizCover is an online comparison platform aggregating quotes from multiple insurers. It\'s fast, transparent, and ideal for sole traders who want instant pricing. Public liability averages $30/month for most trade businesses.',
    keyFeatures: [
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      '40+ years specialist trades experience',
      'Brokers work for you — not the insurer — at claim time',
      'Nationwide branches across the country',
